...
const mockNotices: Notice[] = [
    {
        ...
        type: "order_rejected",
        title: "订单已被驳回",
        content: "您的订单 #1234 因信息不完整被驳回，请重新提交。",
        timestamp: "2025-04-07 10:30",
        read: false,
    },
    {
        id: 2,
        type: "temp_alert",
        title: "冷链箱温度预警",
        content: "冷链箱 C001 当前温度超过设定范围，请立即处理。",
        timestamp: "2025-04-07 08:12",
        read: true,
    },
    {
        id: 3,
        type: "battery_alert",
        title: "电量不足预警",
        content: "冷链箱 C001 电量低于 15%，请尽快充电。",
        timestamp: "2025-04-06 22:48",
        read: false,
    },
]
            ...
            <List>
                {notices.map((notice) => (
                    <List.Item
                        ...
                        prefix={
                            <Tag color={getTagColor(notice.type)}>{getNoticeLabel(notice.type)}</Tag>
                        }
                        onClick={() => {
