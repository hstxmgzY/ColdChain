...
const generateData = () => {
  ...
  return {
    ...
    faults: [
      { name: "温度超限故障", value: Math.floor(Math.random() * 20) },
      { name: "设备物理报错", value: Math.floor(Math.random() * 8) },
      { name: "位置异常", value: Math.floor(Math.random() * 10) },
      { name: "低电量故障", value: Math.floor(Math.random() * 15) },
  ...
  return (
    <div>
      <Row gutter={[16, 16]}>
        <Col span={24}>
          <Card>
            <div ref={container1} style={{ height: 300, width: "100%" }} />
          </Card>
        </Col>

        <Col xs={24} md={12}>
          <Card>
            <div ref={container2} style={{ height: 300, width: "100%" }} />
          </Card>
        </Col>

        <Col xs={24} md={12}>
          <Card>
            <div ref={container3} style={{ height: 300, width: "100%" }} />
          </Card>
        </Col>
      </Row>
    </div>
